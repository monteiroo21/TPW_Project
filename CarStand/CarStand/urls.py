...
urlpatterns = [
    ...
    path('api/groups/<int:id>/brands', views.get_brands_by_group, name='api_get_brands_by_group'),
    path('api/search/<str:type>/', views.unified_unified_search_and_filter_and_filter, name='search'),
