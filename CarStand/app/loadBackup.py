...
def createMotas():
    ...
    moto_model_ktm_1 = Moto(
        ...
        name="KTM 390 Duke",
        base_price=6500,
        specifications="Naked bike with 44 hp, agile handling, and lightweight frame.",
        releaseYear=2021
    )
    moto_model_ktm_1.save()
    Moto.objects.create(
        model=moto_model_ktm_1,
        year=2021,
        new=True,
        kilometers=0,
        price=6500,
    ...
    moto_model_ktm_2 = Moto(
        ...
        base_price=19000,
        specifications="Adventure bike with 160 hp, off-road capability, and advanced electronics.",
        releaseYear=2020
    )
    moto_model_ktm_2.save()
    Moto.objects.create(
        model=moto_model_ktm_2,
        year=2020,
        new=False,
        kilometers=15000,
        price=18000,
        image="static/imgs/motos/ktm_adventure1290.png"
    ).save()
    ...
    moto_model_husqvarna_1 = Moto(
        ...
        base_price=6500,
        specifications="Cafe racer with 44 hp, minimalist design, and lightweight.",
        releaseYear=2020
    )
    moto_model_husqvarna_1.save()
    Moto.objects.create(
        model=moto_model_husqvarna_1,
        year=2020,
        new=True,
        kilometers=0,
        price=6500,
    ...
    moto_model_husqvarna_2 = Moto(
        ...
        base_price=13000,
        specifications="Naked bike with 75 hp, modern styling, and agile handling.",
        releaseYear=2021
    )
    moto_model_husqvarna_2.save()
    Moto.objects.create(
        model=moto_model_husqvarna_2,
        year=2021,
        new=True,
        kilometers=0,
        price=13000,
        image="static/imgs/motos/husqvarna_svartpilen701.png"
    ).save()
    ...
    moto_model_enfield_1.save()
    Moto.objects.create(
        model=moto_model_enfield_1,
        year=2018,
        new=False,
        kilometers=10000,
        price=7500,
    ...
    moto_model_enfield_2.save()
    Moto.objects.create(
        model=moto_model_enfield_2,
        year=2019,
        new=False,
        kilometers=8000,
        price=8000,
        image="static/imgs/motos/royal_enfield_continentalgt650.png"
    ).save()
    ...
    moto_model_bimota_1 = Moto(
        ...
        name="Bimota Tesi H2",
        base_price=45000,
        specifications="High-performance sportbike with a supercharged engine, 231 hp.",
        releaseYear=2021
    )
    moto_model_bimota_1.save()
    Moto.objects.create(
        model=moto_model_bimota_1,
        year=2021,
        new=True,
        kilometers=0,
        price=45000,
    ...
    moto_model_bimota_2 = Moto(
        ...
        name="Bimota KB4",
        base_price=25000,
        specifications="Sportbike with 142 hp, carbon fiber components, and unique styling.",
        releaseYear=2020
    )
    moto_model_bimota_2.save()
    Moto.objects.create(
        model=moto_model_bimota_2,
        year=2020,
        new=True,
        kilometers=0,
        price=25000,
        image="static/imgs/motos/bimota_kb4.png"
    ).save()
    ...
    moto_model_norton_1 = Moto(
        ...
        base_price=18000,
        specifications="Classic bike with 80 hp, designed for performance and style.",
        releaseYear=2017
    )
    moto_model_norton_1.save()
    Moto.objects.create(
        model=moto_model_norton_1,
        year=2017,
        new=False,
        kilometers=5000,
        price=17000,
    ...
    moto_model_norton_2 = Moto(
        ...
        name="Norton V4 RR",
        base_price=40000,
        specifications="Superbike with 200 hp, advanced technology, and race-ready.",
        releaseYear=2021
    )
    moto_model_norton_2.save()
    Moto.objects.create(
        model=moto_model_norton_2,
        year=2021,
        new=True,
        kilometers=0,
        price=40000,
        image="static/imgs/motos/norton_v4rr.png"
    ).save()
    ...
    moto_model_vespa_1 = Moto(
        ...
        base_price=3500,
        specifications="Classic scooter with a 50 cc engine, perfect for city commuting.",
        releaseYear=2021
    )
    moto_model_vespa_1.save()
    Moto.objects.create(
        model=moto_model_vespa_1,
        year=2021,
        new=True,
        kilometers=0,
        price=3500,
    ...
    moto_model_vespa_2 = Moto(
        ...
        name="Vespa GTS 300",
        base_price=5500,
        specifications="Powerful scooter with a 300 cc engine, stylish and comfortable.",
        releaseYear=2020
    )
    moto_model_vespa_2.save()
    Moto.objects.create(
        model=moto_model_vespa_2,
        year=2020,
        new=False,
        kilometers=2000,
        price=5000,
        image="static/imgs/motos/vespa_gts300.png"
    ).save()
